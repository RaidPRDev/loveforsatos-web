...
<div class="innerNavigation">
    <div class="itemNavElement left">
        <div class="itemNav">
            <ul>
                ...
                <li class="navMenuItem" data-menu-id="users" onclick="menuSelect(this)">
                    <div class="navItemIcon"><span class="fas fa-users"></span></div>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="itemNavElement right">
        <div class="itemNav">
            <ul>
                <li class="navMenuItem" data-menu-id="remove" onclick="menuSelect(this)">
                    <div class="navItemIcon"><span class="fas fa-trash-alt"></span></div>
                </li>
                <li class="navMenuItem" data-menu-id="update" onclick="menuSelect(this)">
