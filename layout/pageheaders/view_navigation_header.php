...
<div class="innerNavigation">
    <div class="itemNavElement left vmiddle">
            <div class="itemNavTitle small">
                <i class="fas fa-user"></i>&nbsp;&nbsp;<?=$pageSubTitle?>
            </div>
            ...
            <ul>
                <li class="navMenuItem" data-menu-id="0" onclick="mainNavSelect(this)">
                    ...
                    <div class="dropdown-content right">
                        ...
                        <a href="#" data-menu-id="adopted" data-menu-index="3" data-menu-group="1"
                           onclick="onFilterSelect(this)">
                            <span class="navMenuOptionIcon fas fa-check-circle"></span>
